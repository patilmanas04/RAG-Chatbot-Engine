      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-surface backdrop-blur-xl border border-edge-strong rounded-2xl p-8 shadow-2xl shadow-black/10">
          <div className="text-center mb-8">
            ...
            <p className="text-sm text-body">Sign in to your account to continue</p>
          </div>

          {successMessage && (
            <div className="mb-6 px-4 py-3 rounded-xl bg-emerald-500/10 border border-emerald-500/20 text-emerald-600 text-sm flex items-center gap-2">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            <div>
              <label htmlFor="input-login-email" className="block text-sm font-medium text-body mb-1.5">
                Email address
              </label>
              <input
            ...
            <div>
              <label htmlFor="input-login-password" className="block text-sm font-medium text-body mb-1.5">
                Password
              </label>
